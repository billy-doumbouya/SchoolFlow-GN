...
const NAV_ITEMS = {
  SCHOOL_ADMIN: [
    ...
    { label: 'Enseignants',   href: '/dashboard/admin/teachers',  icon: 'graduation' },
    ...
    { label: 'Paiements',     href: '/dashboard/admin/payments',  icon: 'credit-card' },
  ...
  STUDENT: [
    ...
    { label: 'Mes Notes',     href: '/dashboard/student/grades',    icon: 'bar-chart' },
    { label: 'Planning',      href: '/dashboard/student/schedule',  icon: 'calendar' },
    { label: 'Paiements',     href: '/dashboard/student/payments',  icon: 'credit-card' },
  ],
}

const ICONS = {
  grid:          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M4 5a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1H5a1 1 0 01-1-1V5zm10 0a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1h-4a1 1 0 01-1-1V5zM4 15a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1H5a1 1 0 01-1-1v-4zm10 0a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1h-4a1 1 0 01-1-1v-4z" />,
  ...
  graduation:    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222" />,
  ...
  layers:        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M12 4l8 4-8 4-8-4 8-4zm0 8l8 4-8 4-8-4 8-4z" />,
  ...
  'credit-card': <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />,
...
function Avatar({ name, size = 'md' }) {
  ...
  return (
    <div className={cn('rounded-full flex items-center justify-center text-white font-bold bg-gradient-to-br from-blue-500 to-violet-600 flex-shrink-0', s)}>
      {initials}
    </div>
  )
}
    ...
    <aside style={{
      ...
      <div style={{ padding: '20px 16px 16px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <div style={{ minWidth: 0 }}>
            <p style={{ margin: 0, color: 'white', fontWeight: '700', fontSize: '14px', fontFamily: 'Syne, sans-serif', lineHeight: 1.2 }}>SchoolFlow</p>
            <p style={{ margin: 0, color: '#475569', fontSize: '10px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', maxWidth: '140px' }}>
              {tenant?.name || '—'}
            </p>
          </div>
        </div>
        ...
        {items.map((item) => {
          ...
          return (
            <Link key={item.href} href={item.href} style={{
              ...
              background:   isActive ? 'linear-gradient(135deg,#1a3aeb,#7c3aed)' : 'transparent',
              transition:   'all 0.2s',
            }}
      ...
      <div style={{ padding: '12px 8px', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <Link href="/dashboard/profile" style={{
          ...
          borderRadius: '12px',
          textDecoration: 'none',
          background:   pathname === '/dashboard/profile' ? 'rgba(43,80,245,0.15)' : 'rgba(255,255,255,0.03)',
